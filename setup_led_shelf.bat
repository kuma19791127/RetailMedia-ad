...
echo =========================================================
echo Retail Media サイネージ自動起動セットアップ (棚割り・定番棚 (900x100))
echo =========================================================
echo.
echo このパソコンを「棚割り・定番棚 (900x100)専用」のサイネージとして設定します。
...
set "SHORTCUT_NAME=RetailAd_Signage_shelf.lnk"
...
echo.
echo =========================================================
echo ✅ 棚割り・定番棚 (900x100)の設定が完了しました！
echo =========================================================
