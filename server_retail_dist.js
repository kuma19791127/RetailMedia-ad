...
リテアド・LEDフィルム＆サイネージ Androidアプリ用初期設定ガイド
=========================================================

このファイルは、液晶サイネージモニターや、ガラス面等に貼付する透過型の
「リテアド LEDフィルムサイネージ」のスマートコントローラー（Android OS搭載）で
「リテアドアプリ」をセットアップするための手順書です。
...
■ セットアップ手順
---------------------------------------------------------
1. サイネージ用Android端末（またはLEDフィルムコントローラー）のブラウザ等から、
   リテアド・サイネージプレイヤー アプリ (APKファイル) をダウンロード・インストールします。
