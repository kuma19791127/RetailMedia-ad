...
echo =========================================================
echo Retail Media サイネージ自動起動セットアップ (エンド上部 (900x200))
echo =========================================================
echo.
echo このパソコンを「エンド上部 (900x200)専用」のサイネージとして設定します。
...
set "SHORTCUT_NAME=RetailAd_Signage_endcap.lnk"
